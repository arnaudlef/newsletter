...
1. Commande pour envoyer toutes les newsletters dont les abonnements ont étés validés

docker compose exec php sh -lc "cd /var/www/html && php bin/console app:sendAll:newsletters"

2. Commande pour envoyer une newsletter à tous les inscrits validés de celle-ci (avec "id" un nombre correspondant à l'id de la newsletter souhaitée)
